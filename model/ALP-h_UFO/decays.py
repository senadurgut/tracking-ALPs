...
Decay_ax = Decay(name = 'Decay_ax',
                 particle = P.ax,
                 partial_widths = {(P.a,P.a):'(gaa**2*Max**6)/(16.*cmath.pi*Lbda**2*abs(Max)**3)'})
...
Decay_e__minus__ = Decay(name = 'Decay_e__minus__',
                         ...
                         partial_widths = {(P.W__minus__,P.ve):'(((ee**2*Me**2)/(2.*sw**2) + (ee**2*Mve**2)/(2.*sw**2) + (ee**2*Me**4)/(2.*MW**2*sw**2) - (ee**2*Me**2*Mve**2)/(MW**2*sw**2) + (ee**2*Mve**4)/(2.*MW**2*sw**2) - (ee**2*MW**2)/sw**2)*cmath.sqrt(Me**4 - 2*Me**2*Mve**2 + Mve**4 - 2*Me**2*MW**2 - 2*Mve**2*MW**2 + MW**4))/(32.*cmath.pi*abs(Me)**3)'})

Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.ax,P.ax):'(fs**2*cmath.sqrt(-4*Max**2*MH**2 + MH**4))/(8.*cmath.pi*abs(MH)**3)',
...
Decay_ve = Decay(name = 'Decay_ve',
                 particle = P.ve,
                 partial_widths = {(P.W__plus__,P.e__minus__):'(((ee**2*Me**2)/(2.*sw**2) + (ee**2*Mve**2)/(2.*sw**2) + (ee**2*Me**4)/(2.*MW**2*sw**2) - (ee**2*Me**2*Mve**2)/(MW**2*sw**2) + (ee**2*Mve**4)/(2.*MW**2*sw**2) - (ee**2*MW**2)/sw**2)*cmath.sqrt(Me**4 - 2*Me**2*Mve**2 + Mve**4 - 2*Me**2*MW**2 - 2*Mve**2*MW**2 + MW**4))/(32.*cmath.pi*abs(Mve)**3)'})
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.d__tilde__):'(((-3*CKM2x1*ee**2*MC**2*complexconjugate(CKM2x1))/(2.*sw**2) - (3*CKM2x1*ee**2*MD**2*complexconjugate(CKM2x1))/(2.*sw**2) - (3*CKM2x1*ee**2*MC**4*complexconjugate(CKM2x1))/(2.*MW**2*sw**2) + (3*CKM2x1*ee**2*MC**2*MD**2*complexconjugate(CKM2x1))/(MW**2*sw**2) - (3*CKM2x1*ee**2*MD**4*complexconjugate(CKM2x1))/(2.*MW**2*sw**2) + (3*CKM2x1*ee**2*MW**2*complexconjugate(CKM2x1))/sw**2)*cmath.sqrt(MC**4 - 2*MC**2*MD**2 + MD**4 - 2*MC**2*MW**2 - 2*MD**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
                                          ...
                                          (P.ve,P.e__plus__):'((-(ee**2*Me**2)/(2.*sw**2) - (ee**2*Mve**2)/(2.*sw**2) - (ee**2*Me**4)/(2.*MW**2*sw**2) + (ee**2*Me**2*Mve**2)/(MW**2*sw**2) - (ee**2*Mve**4)/(2.*MW**2*sw**2) + (ee**2*MW**2)/sw**2)*cmath.sqrt(Me**4 - 2*Me**2*Mve**2 + Mve**4 - 2*Me**2*MW**2 - 2*Mve**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.ve,P.ve__tilde__):'((-(ee**2*Mve**2) + ee**2*MZ**2 - (cw**2*ee**2*Mve**2)/(2.*sw**2) + (cw**2*ee**2*MZ**2)/(2.*sw**2) - (ee**2*Mve**2*sw**2)/(2.*cw**2) + (ee**2*MZ**2*sw**2)/(2.*cw**2))*cmath.sqrt(-4*Mve**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
